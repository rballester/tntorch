...
import os
import sys
sys.path.append(os.path.join(os.path.dirname(__name__), '../tntorch'))
sys.path.append(os.path.join(os.path.dirname(__name__), 'tutorials'))

# -- Project information -----------------------------------------------------

project = 'tntorch'
copyright = '2019, Rafael Ballester-Ripoll'
